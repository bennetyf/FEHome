          ...
          <CarouselInner style={{maxHeight:'800px'}}>
            <CarouselItem itemId="1">
                <video className="video-fluid d-block w-100" autoPlay muted loop>
                    <source src="/dynamic/MilkyWay.mp4" type="video/mp4" />
                </video>
              {/* <View>
            ...
            <CarouselItem itemId="2">
                <video className="video-fluid d-block w-100" autoPlay muted loop>
                    <source src="/dynamic/Forest.mp4" type="video/mp4" />
                </video>
              {/* <View>
            ...
            <CarouselItem itemId="3">
                <video className="video-fluid d-block w-100" autoPlay muted loop>
                    <source src="/dynamic/NightSky.mp4" type="video/mp4" />
                </video>
              {/* <View>
            ...
            <CarouselItem itemId="4">
                <video className="video-fluid d-block w-100" autoPlay muted loop>
                    <source src="/dynamic/Hill.mp4" type="video/mp4" />
                </video>
            </CarouselItem>
